...
template<typename T>
Node<T>* treeFromList_helper( const std::vector<std::optional<T>>& payloads, const int pos)
{
...
bool equals(Node<T>* t1, Node<T>* t2)
{
    ...
    return (t1!=t2) && (t1->payload==t2->payload) && equals(t1->left, t2->left)
...
TEST(mirror_binary_tree, test_equals)
{
    ...
    */
    ...
    std::vector<std::optional<int>> values_mirror = {1,std::nullopt,2, std::nullopt, std::nullopt, 5};
...
TEST(mirror_binary_tree, test_example1)
{
    ...
    */
      ...
      std::vector<std::optional<int>> values_mirror = {5,6,3,std::nullopt,std::nullopt,4,2};
...
TEST(mirror_binary_tree, test_example2)
{
    /*
      1      1
        2  2  
    */
      std::vector<std::optional<int>> values = {2,1,8,12,std::nullopt,9,std::nullopt};
      std::vector<std::optional<int>> values_mirror = {2,8,1,std::nullopt,9,std::nullopt,12};
...
TEST(mirror_binary_tree, test_example3)
{
    /*
      1      1
        2  2  
    */
      std::vector<std::optional<int>> values = {1,2,3,4,5,6,7,std::nullopt,std::nullopt,std::nullopt,6,7,std::nullopt,std::nullopt,std::nullopt};
      std::vector<std::optional<int>> values_mirror = {1,3,2,7,6,5,4,std::nullopt,std::nullopt,std::nullopt,7,6,std::nullopt,std::nullopt,std::nullopt};
