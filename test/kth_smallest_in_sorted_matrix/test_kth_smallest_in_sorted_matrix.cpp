...
TEST(kth_smallest_in_sorted_matrix, example1)
{
...

  {
    ...
    EXPECT_EQ(expected, kth_smallest_in_sorted_matrix_brute_force_constant_space(input, k));
...
TEST(kth_smallest_in_sorted_matrix, simple)
{
  ...
  for (int i = 1; i <= 9; i++)
  {
    EXPECT_EQ(i, kth_smallest_in_sorted_matrix_brute_force_constant_space(input, i));
...
TEST(kth_smallest_in_sorted_matrix, allEqual)
{
  ...
  for (int i = 1; i <= 9; i++)
  {
    EXPECT_EQ(1, kth_smallest_in_sorted_matrix_brute_force_constant_space(input, i));
