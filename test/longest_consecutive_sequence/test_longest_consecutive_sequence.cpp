...
TEST(longest_consecutive_sequence, test_100_consecutive)
{
  ...
  const std::vector<int> base_input = {
      60, 45, 31, 18, 59,  87, 37, 17, 86, 79, 70, 20, 44, 26, 5,  9,  98,
      4,  71, 65, 28, 56,  25, 49, 51, 48, 16, 83, 84, 12, 2,  38, 91, 14,
      32, 22, 81, 80, 74,  10, 11, 57, 7,  54, 95, 88, 92, 50, 76, 72, 33,
      36, 47, 85, 13, 89,  63, 43, 93, 68, 52, 66, 29, 90, 78, 58, 23, 27,
      69, 3,  67, 6,  21,  41, 55, 19, 62, 82, 64, 15, 42, 24, 46, 94, 34,
      75, 30, 1,  40, 100, 35, 73, 39, 53, 99, 96, 97, 77, 8,  61};
  {
    int shuffles = kShuffles;
    do
    {
...
TEST(longest_consecutive_sequence, test_100_repeated_twice_consecutive)
{
  ...
  const std::vector<int> base_input = {
      ...
      36, 47, 85,  13, 89, 63,  43, 93, 68, 52, 66, 29, 90, 78, 58, 23, 27,
      69, 3,  67,  6,  21, 41,  55, 19, 62, 82, 64, 15, 42, 24, 46, 94, 34,
      75, 60, 45,  31, 18, 59,  87, 37, 17, 86, 79, 70, 20, 44, 26, 5,  9,
      98, 4,  71,  65, 28, 56,  25, 49, 51, 48, 16, 83, 84, 12, 2,  38, 91,
      14, 32, 22,  81, 80, 74,  10, 11, 57, 7,  54, 95, 88, 92, 50, 76, 72,
      33, 36, 47,  85, 13, 89,  63, 43, 93, 68, 52, 66, 29, 90, 78, 58, 23,
      27, 69, 3,   67, 6,  21,  41, 55, 19, 62, 82, 64, 15, 42, 24, 46, 94,
      34, 75, 30,  1,  40, 100, 35, 73, 39, 53, 99, 96, 97, 77, 8,  61, 30,
      1,  40, 100, 35, 73, 39,  53, 99, 96, 97, 77, 8,  61};
  {
    int shuffles = kShuffles;
    do
    {
...
TEST(longest_consecutive_sequence,
     test_random_vector_100_elements_from_123_to_223)
{
  const std::vector<int> base_input =
      Book::Algorithm::generate_random_vector_in_range(100, 123, 223);
