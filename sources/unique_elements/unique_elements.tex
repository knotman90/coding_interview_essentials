...
\lstinputlisting[language=c++, caption="C++ solution for determining all characters in a string are unique.",label=list:unique_elements_brute_force1]{/home/dspataro/git/algorithm_articles/sources/unique_elements/unique_elements_brute_force.cpp}
...
\lstinputlisting[language=c++, caption="C++ solution for determining if all characters in a string are unique using \inline{std::find}",label=list:unique_elements_brute_force2]{/home/dspataro/git/algorithm_articles/sources/unique_elements/unique_elements_brute_force_std.cpp}
...
\lstinputlisting[language=c++, caption="C++ solution for determining all characters in a string are unique in $O(n)$ using an hashset.",label=list:unique_elements_brute_force_map]{/home/dspataro/git/algorithm_articles/sources/unique_elements/unique_elements_brute_force_map.cpp}
...
\lstinputlisting[language=c++, caption="C++ solution for determining all characters in a string are unique in $O(n)$ using an hashset.",label=list:unique_elements_brute_force_final]{/home/dspataro/git/algorithm_articles/sources/unique_elements/unique_elements_brute_force_final.cpp}
