...
\lstinputlisting[language=c++, caption="C++ solution of the two number sum problem with a brute force approach.",label=list:two_number_sum_bruteforce]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/brute_force.cpp}
...
\textbf{The space complexity is $O(1)$}.
...
\lstinputlisting[language=c++, caption="C++ solution of the two number sum problem using hashing.",label=list:two_number_sum_hashing]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/hashset.cpp}
...
\inline{H.find(T-a_k)} to return \textbf{true} which is wrong because this correspond to a solution where we sum $a_k$ twice to obtain $T$.
...
\lstinputlisting[language=c++, caption="C++ solution of the two number sum problem with sorting and binary search.",label=list:two_number_sum_sorting]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/two_numbers_sum_sorting.cpp}
...
Listing \ref{list:two_number_sum_two_pointers} shows an implementation of the idea above.  Notice that compared to the solution using the binary search, this one is shorter and simpler to write. Moreover does not use library functions. 

\lstinputlisting[language=c++, caption="C++ solution of the two number sum problem with the two pointers tecnique.",label=list:two_number_sum_two_pointers]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/two_numbers_sum_two_pointers.cpp}
...
\lstinputlisting[language=c++, caption="Brute force na\"ive solution to the four numbers sum problem.",label=list:two_number_sum_naive]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/variations/four_number_sum/four_number_sum_solution1.cpp}
...
\lstinputlisting[language=c++, caption="Brute force cubic time solution to the four numbers sum problem.",label=list:two_number_sum_cubic]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/variations/four_number_sum/four_number_sum_solution2.cpp}
...
\lstinputlisting[language=c++, caption="Quadratic time solution to the four numbers sum problem.",label=list:two_number_sum_quadratic]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/variations/four_number_sum/four_number_sum_solution3.cpp}
...
\lstinputlisting[language=c++, caption="Space optimized quadratic time solution to the four numbers sum problem.",label=list:two_number_sum_quadratic_opti]{/home/dspataro/git/algorithm_articles/sources/two_numbers_sum/variations/four_number_sum/four_number_sum_solution4.cpp}
