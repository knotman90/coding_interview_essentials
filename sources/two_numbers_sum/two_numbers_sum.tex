...
\lstinputlisting[language=c++, caption="\CC solution of the two number sum problem with a brute force approach.",label=list:two_number_sum_bruteforce]{sources/two_numbers_sum/brute_force.cpp}
...
\lstinputlisting[language=c++, caption="\CC solution of the two number sum problem using hashing.",label=list:two_number_sum_hashing]{sources/two_numbers_sum/hashset.cpp}
...
Listing \ref{list:two_number_sum_sorting} shows a \CC implementation of this idea. Notice that it uses \inline{std::binary_search} from the \CC standard library and that a possible follow-up question might be to show your own version of the binary search algorithm.



\lstinputlisting[language=c++, caption="\CC solution of the two number sum problem with sorting and binary search.",label=list:two_number_sum_sorting]{sources/two_numbers_sum/two_numbers_sum_sorting.cpp}
...
\lstinputlisting[language=c++, caption="\CC solution of the two number sum problem with the two pointers tecnique.",label=list:two_number_sum_two_pointers]{sources/two_numbers_sum/two_numbers_sum_two_pointers.cpp}
...
\subsubsection{Na\"ive $O(n^4)$ solution}
...
\subsubsection{$O(n^2)$ solution using hashing}
