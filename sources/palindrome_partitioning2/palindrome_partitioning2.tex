...
\inline{palindrome_partitioning2_DP_helper} has an almost 1-to1 mapping to the Equation
...
Listing \ref{} shows an implementation of this idea in the function \inline{xxx}. Notice that the
code for \inline{xxx} is almost identical to the one of \inline{xxxx} in Listing \ref{} with the
...
You can ignore the \inline{hash_combine} and \inline{PairHasher} as their only purpose is to 
