...
\begin{figure}
	\centering
	\includegraphics{/home/dspataro/git/algorithm_articles/sources/min_rotated_array/images/arrayrotation}
...
\lstinputlisting[language=c++, caption=One-linear brute force (using C++ STL) solution to the problem of finding the minimum element in a sorted rotated array.,label=list:min_rotated_array_bf]{/home/dspataro/git/algorithm_articles/sources/min_rotated_array/min_rotated_array_solution1.cpp}

\lstinputlisting[language=c++, caption=One-linear brute force solution to the problem of finding the minimum element in a sorted rotated array.,label=list:min_rotated_array_bf_manual]{/home/dspataro/git/algorithm_articles/sources/min_rotated_array/min_rotated_array_solution2.cpp}
...
\begin{figure}
	\centering
	\includegraphics{/home/dspataro/git/algorithm_articles/sources/min_rotated_array/images/inflection_point}
...
\lstinputlisting[language=c++, caption={Logaritmic solution to the problem of finding the minimum element in a sorted and rotated array.},label=list:min_rotated_array_log]{/home/dspataro/git/algorithm_articles/sources/min_rotated_array/min_rotated_array_solution3.cpp}
