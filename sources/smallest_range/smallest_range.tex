...
%   \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/example1} \caption[Sample short
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.90\textwidth}
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/explanation1} 
	...
	\medskip
	\begin{subfigure}[t]{0.90\textwidth}
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/explanation2} 
...
range, respectively.
\lstinputlisting[language=c++, caption={Solution to the \textit{smallest range} problem.},label=list:smallest_range:solution1]{/home/dspataro/git/algorithm_articles/sources/smallest_range/smallest_range_solution1.cpp}
...
\begin{exercise}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/bars}
...
\lstinputlisting[language=c++, caption={Solution to the \textit{smallest range} problem using sorting.},label=list:smallest_range:solution2]{/home/dspataro/git/algorithm_articles/sources/smallest_range/smallest_range_solution2.cpp}

\begin{figure}[bp!]
	\centering	
	\begin{subfigure}[t]{0.99\textwidth}
			\centering
			\includegraphics[width=1\linewidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/bars2}
			\caption{$j=0$}
...
\begin{figure}\ContinuedFloat
	...
	\begin{subfigure}{0.99\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/bars3}
		\caption{$j=1$}
	...
	\begin{subfigure}{0.99\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/bars4}
		\subcaption{$j=1$}
	...
	\begin{subfigure}{0.99\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/bars5}
		\subcaption{$j=1$}
...
\begin{figure}\ContinuedFloat
	\begin{subfigure}{0.99\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{/home/dspataro/git/algorithm_articles/sources/smallest_range/images/bars6}
		\subcaption{$j=1$}
