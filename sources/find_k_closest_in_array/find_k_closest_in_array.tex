...
\lstinputlisting[language=c++, caption={Solution to the problem of finding the $k$ closest element using sorting.},label=list:find_k_closest_in_array2]{/home/dspataro/git/algorithm_articles/sources/find_k_closest_in_array/find_k_closest_in_array_solution2.cpp}
...
\lstinputlisting[language=c++, caption={Solution to the problem of finding the $k$ closest element using \inline{std::lower\_bound}.},label=list:find_k_closest_in_array3]{/home/dspataro/git/algorithm_articles/sources/find_k_closest_in_array/find_k_closest_in_array_solution3.cpp}
