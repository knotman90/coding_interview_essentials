...
\begin{minipage}{\linewidth}
	\lstinputlisting[language=c++, caption={Implementation of a function for the calculation of the \textit{lower\_bound} that can be using in substitution of \inline{std::lower\_bound} in Listing \ref{list:find_k_closest_in_array2}.},label=list:cycle_in_list:node_definition]{sources/find_k_closest_in_array/my_lower_bound.h}
\end{minipage}