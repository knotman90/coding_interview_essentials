...
%\begin{figure} \centering \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_triplet/images/example1}
...
\lstinputlisting[language=c++, caption={Cubic time complexity bruteforce solution.},label=list:max_triplet_bruteforce]{/home/dspataro/git/algorithm_articles/sources/max_triplet/max_triplet_solution1.cpp}
...
\lstinputlisting[language=c++, caption={$O(nlog(n))$ solution to the max triplet sum problem.},label=list:max_triplet]{/home/dspataro/git/algorithm_articles/sources/max_triplet/max_triplet_solution2.cpp}