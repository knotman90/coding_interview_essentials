...
\inline{s="xy242[ab3[c]de]}. We start by reading $x$ and $y$ which are letters and therefore are
...
function \inline{decode_string_recursive_helper} takes as a second parameter a reference to an index
...
input string \inline{ab23[x12[w]]cd}.
