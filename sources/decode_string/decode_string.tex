...
%\begin{figure} \centering \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/decode_string/images/example1}
...
\lstinputlisting[language=c++, caption={Recursive implementation of the algorithm described in Section \ref{decode_string:sec:recursive}},label=list:decode_string:recursive]{/home/dspataro/git/algorithm_articles/sources/decode_string/decode_string_solution2.cpp}
...
\begin{figure}
	...
	\centering
	\hspace*{-1.5cm}
	\includegraphics[width=1.25\textwidth]{/home/dspataro/git/algorithm_articles/sources/decode_string/images/recursion}
	\vspace*{-10mm}
...
\lstinputlisting[language=c++, caption={Iterative solution using a \inline{std::stack}.},label=list:decode_string:iterative]{/home/dspataro/git/algorithm_articles/sources/decode_string/decode_string_solution1.cpp}
