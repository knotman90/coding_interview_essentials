...
Moreover, notice the usage \inline{std::reserve}: it should be used in all those scenarios when we already know the final size of the collection we are building.
