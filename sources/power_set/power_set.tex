...
As we will see, the two proposed solution  will have similar performance in terms of time space required, but the latter is in our opinion easier to explain and results in shorter and simpler code. 
...
The second approach to solving this problem is based on the [FACT/PREMISE?] that the values of the
