...
\section{Clarification Questions}
    ...
    \begin{QandA}
        ...
        \item \begin{questionitem} \begin{question} Is it guaranteed for the complexity values to be positive ($\geq 0$)?  \end{question}          
    \begin{answered}
...
(the equivalent of the function $C$). Note that given $I$ and $d$ the function can "only"  be
