...
\lstinputlisting[language=c++, caption={Function that generates all the combinations of size $k$ from the elements $\{0,1,\ldots,l\}$},label=list:min_difficulty_job_scheduler:combinations]{/home/dspataro/git/algorithm_articles/sources/min_difficulty_job_scheduler/generate_combination.h}
...
\lstinputlisting[language=c++, caption={Dynamic programming top-down solution.},label=list:min_difficulty_job_scheduler:solutiondp]{/home/dspataro/git/algorithm_articles/sources/min_difficulty_job_scheduler/min_difficulty_job_scheduler_solution2.cpp}
...
\lstinputlisting[language=c++, caption={Dynamic programming bottom-up solution. },label=list:min_difficulty_job_scheduler:solutiondpbottomup]{/home/dspataro/git/algorithm_articles/sources/min_difficulty_job_scheduler/min_difficulty_job_scheduler_solution3.cpp}
