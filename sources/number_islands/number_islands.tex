...
\begin{figure}
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/number_islands/images/example1}
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/number_islands/images/visited}
...
\lstinputlisting[language=c++, caption={Iterative DFS solution to the problem of counting the number of islands in a map.},label=list:number_islands:iterative]{/home/dspataro/git/algorithm_articles/sources/number_islands/number_islands_solution1.cpp}
...
\lstinputlisting[language=c++, caption={Alternative iterative DFS solution, without dedicated space for marking visited cells,  to the problem of counting the number of islands in a map.},label=list:number_islands:iterative_1]{/home/dspataro/git/algorithm_articles/sources/number_islands/number_islands_solution2.cpp}
...
\lstinputlisting[language=c++, caption={Recursive DFS solution, to the problem of counting the number of islands in a map.},label=list:number_islands:recursive]{/home/dspataro/git/algorithm_articles/sources/number_islands/number_islands_solution3.cpp}