...
\begin{figure}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{/home/dspataro/git/algorithm_articles/sources/distance_between_nodes_in_tree/images/example2}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/distance_between_nodes_in_tree/images/example1}
		\caption{Binary Search tree of the Example
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/distance_between_nodes_in_tree/images/example3}
		\caption{}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/distance_between_nodes_in_tree/images/example4}
		\caption{}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/distance_between_nodes_in_tree/images/example5}
		\caption{}
...
\end{figure}
	...
	\lstinputlisting[language=c++, caption={Solution to the problem of finding the distance between two nodes in a binary search tree.},label=list:distance_between_nodes_in_tree]{/home/dspataro/git/algorithm_articles/sources/distance_between_nodes_in_tree/distance_between_nodes_in_tree_solution1.cpp}
