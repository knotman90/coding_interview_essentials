...
%   \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_num_chunks_sorted/images/example1}
...
Listing \ref{list:max_num_chunks_sorted:bruteforce} shows a C++ implementation of such idea. 
    ...
    \lstinputlisting[language=c++, caption={Bruteforce solution to the problem \textit{Sort the chunks, sort the array}.},label=list:max_num_chunks_sorted:bruteforce]{/home/dspataro/git/algorithm_articles/sources/max_num_chunks_sorted/max_num_chunks_sorted_solution1.cpp}
...
\begin{figure}
  \centering
   \includegraphics[width=0.6\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_num_chunks_sorted/images/example1}
...
\lstinputlisting[language=c++, caption={Linear time solution to the problem \textit{Sort the chunks, sort the array}.},
    label=list:max_num_chunks_sorted:linear]{/home/dspataro/git/algorithm_articles/sources/max_num_chunks_sorted/max_num_chunks_sorted_solution2.cpp}