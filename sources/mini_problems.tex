...
\lstinputlisting[language=c++, caption={Linear time solution.},label=list:list:trim_text:lineartime:lineartime]{test/mini_problems/trim_text/trim_text_solution1.cpp}
