...
which on most the common modern \CC implementation is $32$-bit (\inline{sizeof(int)}) and therefore
...
machine instructions, or by using some simple bit manipulation trickery. From \CC20 we also can use
