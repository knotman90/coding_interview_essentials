...
\lstinputlisting[language=c++, caption={Sample Caption},label=list:majority_element:bruteforce]{/home/dspataro/git/algorithm_articles/sources/majority_element/majority_element_solution1.cpp}
...
\lstinputlisting[language=c++, caption={Solution to the problem of finding the majority element in an array using hash-map.},label=list:majority_element:hashmap]{/home/dspataro/git/algorithm_articles/sources/majority_element/majority_element_solution2.cpp}
...
\lstinputlisting[language=c++, caption={Solution  to the problem of finding the majority element in an array using sorting.},label=list:majority_element:sorting]{/home/dspataro/git/algorithm_articles/sources/majority_element/majority_element_solution3.cpp}
...
\lstinputlisting[language=c++, caption={Linear time constant space solution to the problem of finding the majority element in an array.},label=list:majority_element:median]{/home/dspataro/git/algorithm_articles/sources/majority_element/majority_element_solution4.cpp}
...
\lstinputlisting[language=c++, caption={Linear time constant space solution to the problem of finding the majority element in an array.},label=list:majority_element:moore]{/home/dspataro/git/algorithm_articles/sources/majority_element/majority_element_solution5.cpp}
