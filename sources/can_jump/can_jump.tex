...
The code works by first calling the function \inline{build_equal_map} that is responsible constructing the map mentioned above where indices of those cells sharing the same value are grouped together.
