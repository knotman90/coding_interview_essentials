...
\begin{figure}
	...
	\centering
	\includegraphics[scale=1.0]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/example2}
...
\begin{figure}
	...
	\centering
	\includegraphics[scale=1.0]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/example1}
...
\lstinputlisting[language=c++, caption={Naive implementation of solution to the problem of finding the median of two sorted arrays.},label=list:median_sorted_naive]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/median_sorted_arrays_solution1.cpp}
...
\lstinputlisting[language=c++, caption={Naive implementation of solution to the problem of finding the median of two sorted arrays using the merge part of merge-sort algorithm.},label=list:median_sorted_naive_2]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/median_sorted_arrays_solution2.cpp}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays0}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays1}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays2}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays3}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays4}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays5}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays6}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays7}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[trim=0 0 0 45,clip,width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/images/mergearrays8}
...
\lstinputlisting[language=c++, caption={Binary search solution to the \textit{median of two sorted arrays} problem.},label=list:median_sorted_binary]{/home/dspataro/git/algorithm_articles/sources/median_sorted_arrays/median_sorted_arrays_solution3.cpp}
