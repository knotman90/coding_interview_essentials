...
\lstinputlisting[language=c++, caption=C++ solution to the string to integer problem.,label=list:string_to_int1]{/home/dspataro/git/algorithm_articles/sources/string_to_int/string_to_int_solution1.cpp}
...
\lstinputlisting[language=c++, caption=C++ solution to the string to integer problem with negative number support.,label=list:string_to_int_negative]{/home/dspataro/git/algorithm_articles/sources/string_to_int/string_to_int_solution2.cpp}