...
This problem is remarkably similar to what how the function \inline{std::unique} from the STL library behaves. 
...
\end{enumerate}
This function is often used in pair with \inline{std::erase} to delete the second part of the newly arranged collection.
...
Despite we cannot do much better than spending linear time, we can improve on the space and bring it down to constant.
