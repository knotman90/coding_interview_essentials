...
\lstinputlisting[language=c++, caption={Brute force $O(n^2)$ solution to the problem of buying and selling stock.},label=list:buy_sell_stocks:bruteforce]{/home/dspataro/git/algorithm_articles/sources/buy_sell_stocks/buy_sell_stocks_solution1.cpp}
...
\lstinputlisting[language=c++, caption={Dynamic programming linear time, constant space solution to the problem of buying and selling stock.},label=list:buy_sell_stocks:linear]{/home/dspataro/git/algorithm_articles/sources/buy_sell_stocks/buy_sell_stocks_solution2.cpp}


%Multiple transaction variation
\input{/home/dspataro/git/algorithm_articles/sources/buy_sell_stocks/buy_sell_stocks_2/buy_sell_stocks_2.tex}