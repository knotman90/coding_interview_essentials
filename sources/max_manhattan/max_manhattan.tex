...
\ref{eq:max_manhattan:dpformula}) into a \CC recursive function, and we can use memoization (in the
...
memoization cache and then to call the \CC equivalent of function $S$ (see Equation
