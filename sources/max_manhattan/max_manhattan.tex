...
%\begin{figure} \centering \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/example1}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/distance_manhattan2}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/neighborhood}
...
\lstinputlisting[language=c++, caption={Brute Force solution to the problem of finding the max cell within the manhattan neighborhood of size $K$.},label=list:max_manhattan:bruteforce]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/max_manhattan_solution1.cpp}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{1.0\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/neighborhoodDP1_1}
        \caption[]{Manahtann neighborhoods of size $1$ for the cells \begin{itemize*}
            \item $(x,y)$ (center)
            \item $(x+1,y)$ (right)
            \item $(x-1,y)$ (left)
            \item $(x,y-1)$ (top)
            \item $(x,y+1)$ (down) \end{itemize*}}
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/neighborhoodDP1_2}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{1.0\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/neighborhoodDPK2_1}
        \caption[]{Manahtann neighborhoods of size $1$ for the cells \begin{itemize*}
            \item $(x,y)$ (center)
            \item $(x+1,y)$ (right)
            \item $(x-1,y)$ (left)
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/images/neighborhoodDPK2_2}
...
\lstinputlisting[language=c++, caption={DP top-down solution to the problem of finding the max cell within the manhattan neighborhood of size $K$.},label=list:max_manhattan:dp_topdown]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/max_manhattan_solution2.cpp}
...
respectively. 
\lstinputlisting[language=c++, caption={DP bottom-down solution to the problem of finding the max cell within the manhattan neighborhood of size $K$.},label=list:max_manhattan:dp_bottomup]{/home/dspataro/git/algorithm_articles/sources/max_manhattan/max_manhattan_solution3.cpp}
