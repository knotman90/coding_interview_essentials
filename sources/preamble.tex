...
\usepackage{fontspec} % Use 8-bit encoding that has 256 glyphs
\newfontfamily\test[Path=./fonts/]{PlayfairDisplay-Black.ttf}
...
\input{sources/title_and_author.tex}
...
\newenvironment{questionitem}{}{}

\newenvironment{question}{\par\bfseries}{}
\newenvironment{answered}{\par\normalfont}{}
\newenvironment{QandA}
	{\begin{enumerate}[label=\bfseries Q.\arabic*.,leftmargin=2em,rightmargin=2em]\bfseries}
	{\end{enumerate}}
%----------------------------------------------------------------------------------------
%	ALGORITHM
%----------------------------------------------------------------------------------------
...
\newcommand{\inline}[1]{\ \lstinline[breaklines=true]{#1}}
...
\newcounter{chessex}
\newcommand\printchessex{\refstepcounter{chessex}Chessboard \thechessex}
...
\usepackage{pdfpages} % for the book cover inclusion
\usepackage{nameref}
\usepackage{wrapfig}
...
\newcommand{\GoogleLogo}{\faGoogle Google}



\usepackage{xparse}

\definecolor{questionmagenta}{RGB}{237,53,114} % Define the orange color used for highlighting throughout the book
\definecolor{questionanswergreen}{RGB}{119,197,147}
% coo question box	  
\newmdenv[skipabove=7pt,
skipbelow=7pt,
rightline=false,
...
topline=false,
bottomline=false,
backgroundcolor=questionmagenta!10,
linecolor=questionmagenta,
innerleftmargin=5pt,
innerrightmargin=5pt,
innertopmargin=-0pt,
...
leftmargin=0cm,
rightmargin=0cm,
linewidth=4pt]{questionBox}
\newtheorem{cppexerciseT}{\CC Question}
\newenvironment{cppquestion}{\begin{questionBox}\begin{cppexerciseT}}{\hfill{\color{ocre}}\end{cppexerciseT}\end{questionBox}}
...
topline=false,
bottomline=false,
backgroundcolor=questionanswergreen!10,
linecolor=questionanswergreen,
innerleftmargin=5pt,
innerrightmargin=5pt,
innertopmargin=-0pt,
innerbottommargin=-1ex
leftmargin=0cm,
rightmargin=0cm,
linewidth=4pt]{answerBox}
\newtheorem{cppanwserT}{\CC Answer}
\newenvironment{cppanswer}{\begin{answerBox}\begin{cppanwserT}}{\hfill{\color{ocre}}\end{cppanwserT}\end{answerBox}}
...
\setlist[choices,1]{label=\Alph*., itemjoin={{\quad}}}
