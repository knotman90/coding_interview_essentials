...
The idea we developed in Section \ref{max_gap:sec:trivia} can be improved 
...
The sorting works by repeatedly sorting the input list from the least to the most significant digit where each of the intermediate 
