...
%\begin{figure} \centering \includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_gap/images/example1}
...
\end{itemize}
\lstinputlisting[language=c++, caption={Trivial solution to the max gap problem using sorting and linear space.},label=list:max_gap:bruteforce]{/home/dspataro/git/algorithm_articles/sources/max_gap/max_gap_solution1.cpp}
...
\lstinputlisting[language=c++, caption={Linear time solution to the max gap problem using radix-sort.},label=list:max_gap:radixsort]{/home/dspataro/git/algorithm_articles/sources/max_gap/max_gap_solution2.cpp}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_gap/images/move_t}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{/home/dspataro/git/algorithm_articles/sources/max_gap/images/bucketing_example1}
...
\lstinputlisting[language=c++, caption={Linear time solution to the max gap problem using bucketing.},label=list:max_gap:buckets]{/home/dspataro/git/algorithm_articles/sources/max_gap/max_gap_solution3.cpp}