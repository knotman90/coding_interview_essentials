...
\lstinputlisting[language=c++, caption=Sample Caption,label=list:max_sum_continguous_subarray_bruteforce]{/home/dspataro/git/algorithm_articles/sources/max_sum_continguous_subarray/max_sum_continguous_subarray_solution1.cpp}
...
\lstinputlisting[language=c++, caption=Sample Caption,label=list:max_sum_continguous_subarray_bruteforce_improved]{/home/dspataro/git/algorithm_articles/sources/max_sum_continguous_subarray/max_sum_continguous_subarray_solution3.cpp}
...
\lstinputlisting[language=c++, caption=Sample Caption,label=list:max_sum_continguous_subarray_kadane_additional_space]{/home/dspataro/git/algorithm_articles/sources/max_sum_continguous_subarray/max_sum_continguous_subarray_solution2.cpp}
...
\lstinputlisting[language=c++, caption=Sample Caption,label=list:max_sum_continguous_subarray_kadane]{/home/dspataro/git/algorithm_articles/sources/max_sum_continguous_subarray/max_sum_continguous_subarray_solution4.cpp}
